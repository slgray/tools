...
# -*- coding: utf-8 -*- 
#
# bluffstone@gmail.com
# date: 2012-10-12
# 
# 特别说明：此脚本是在网址所列代码基础上修改而成：By zhangzhenhu   http://blog.csdn.net/zhangzhenhu/article/details/7014271
# 
...
def deal(file_name):
    ...
    for count,py,word in GTable:
        ...
        f.write( unicode( word + '\t' + py + '\t' + '1').encode('UTF-8') )#最终保存文件的编码，可以自给改
        f.write('\n')
    f.close()  
    print "词库成功写入文件：",txt_file_name
    print "++++++++++++++++++++++++++++++++++"
